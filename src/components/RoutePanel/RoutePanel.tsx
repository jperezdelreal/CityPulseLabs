...
import { isRoutingDemoMode } from '../../services/routing.ts';
...
export default function RoutePanel({
  ...
  return (
    <div className="p-4 space-y-3">
      ...
      {isRoutingDemoMode() && routesWithConfidence.length > 0 && (
        <div className="text-xs text-amber-700 bg-amber-50 border border-amber-200 px-3 py-2 rounded-lg">
          ⚠️ Modo demo — las rutas son simuladas. Configure <code>VITE_ORS_API_KEY</code> para rutas reales.
        </div>
      )}
